...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, emb, heads=8, mask=False, ff_dim=2048):
        ...
        # self.attention is an object (instance of MultiHeadSelfAttention).
    ...
    def forward(self, x):
        ...
        # Calling self.attention(x) invokes its forward method, which performs the multi-head self-attention computation and returns a tensor.
