...
from nanochat.tokenizer import get_tokenizer, NanoChatTokenizer
...
for tokenizer_name in ["gpt2", "gpt4", "ours"]:
    ...
    if tokenizer_name == "gpt2":
        tokenizer = NanoChatTokenizer.from_pretrained("gpt2") # gpt-2 base model tokenizer
    elif tokenizer_name == "gpt4":
        tokenizer = NanoChatTokenizer.from_pretrained("cl100k_base") # gpt-4 base model tokenizer
    else:
